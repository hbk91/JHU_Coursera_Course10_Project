...
```{r, label = 'banned_words', include=FALSE}
banned_words <- c('fuck','dick','motherfucker','dick','bastard', 'asshole', 'wanker',
                  'fucking')
```


```{r, label = 'data_cleaning'}
